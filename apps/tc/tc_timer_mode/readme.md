...
| ----------------- | ---------------------------------------------- |
| pic32cm_jh00_curiosity_pro | MPLABX project for [PIC32CM JH01 Curiosity Pro Evaluation Kit]() |
|||
...
| Project Name| Board|
|:---------|:---------:|
| pic32cm_jh00_curiosity_pro | [PIC32CM JH01 Curiosity Pro Evaluation Kit]()
|||
