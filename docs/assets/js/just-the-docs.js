...
{"0": {
    ...
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cm_jh01_curiosity_pro.X | PIC32CM JH01 Curiosity Pro Evaluation Kit | . |   |   | . Setting up PIC32CM JH01 Curiosity Pro Evaluation Kit . | Use a jumper wire to connect pin PB06 “Pin 4 of the EXT3 connector” and PA02 “Pin DAC_VOUT on the DAC Header” | Use the Logic Analyzer/Oscilloscope and probe PB12 pin (Pin 7 of the EXT2 header) to observe the PWM output | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "ADC DMA sleepwalking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cm_jh01_curiosity_pro.X | PIC32CM JH01 Curiosity Pro Evaluation Kit | . |   |   | . Setting up PIC32CM JH01 Curiosity Pro Evaluation Kit . | Connect a voltage below the selected ADC reference voltage (VDDANA) to pin 5 (PA10 – ADC0_AIN10) of the EXT1 connector | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "ADC Sample",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cm_jh01_curiosity_pro.X | PIC32CM JH01 Curiosity Pro Evaluation Kit | . |   |   | . Setting up PIC32CM JH01 Curiosity Pro Evaluation Kit . | Analog input (AIN10) is fed from the DAC output . | Analog input “AIN10” is mapped to Port Pin “PA10” that is routed to “Pin 5 of the EXT1 header” | DAC output “DAC” is mapped to Port Pin “PA02” that is routed to “Pin 1 of the DAC-OUT header” | Use a jumper wire to Connect “Pin 5 of the EXT1 header” to “Pin 1 of the DAC-OUT header” | . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "CCL Manchester Encoder",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cm_jh01_curiosity_pro.X | PIC32CM JH01 Curiosity Pro Evaluation Kit | . |   |   | . Setting up PIC32CM JH01 Curiosity Pro Evaluation Kit . | Use jumper from PA19 (EXT1 pin 18) to PA10 (EXT1 pin 5). This routes SCK signal to CCL_IN5 | Use jumper from PA18 (EXT1 pin 16) to PC27 (EXT1 pin 17). This routes MOSI signal to CCL_IN4 | PA11 (EXT1 pin 6) has CCL output (CCL_OUT1) | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    ...
    "doc": "AC Sleepwalking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cm_jh01_curiosity_pro.X | PIC32CM JH01 Curiosity Pro Evaluation Kit | . |   |   | . Setting up PIC32CM JH01 Curiosity Pro Evaluation Kit . | Connect a voltage below VDD to pin 4 of the EXT3 connector | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
